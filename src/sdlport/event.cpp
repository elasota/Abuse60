                ...
                case SDL_KEYUP:
                {
                    ...
                    switch( event.key.keysym.sym )
                    {
                        ...
                        case SDLK_F11:
                        {
                            ...
                            {
                                // Toggle fullscreen
                                Uint32 fsFlags = (SDL_GetWindowFlags(window) & SDL_WINDOW_FULLSCREEN_DESKTOP);
                                SDL_SetWindowFullscreen(window, fsFlags ^SDL_WINDOW_FULLSCREEN_DESKTOP);
                            }
                            ev.key = EV_SPURIOUS;
                            break;
                        }
                        ...
                        case SDLK_PRINTSCREEN:    // print-screen key
                        {
                            ...
                            {
                                // Grab a screenshot
                                SDL_SaveBMP( SDL_GetWindowSurface(window), "screenshot.bmp" );
